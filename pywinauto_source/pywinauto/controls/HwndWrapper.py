...
#
    ...
    #-----------------------------------------------------------
    def PressMouseInput(self, button = "left", coords = (None, None), pressed = "", absolute = False):
        "Press a mouse button using SendInput"
        _perform_click_input(self, button, coords, button_up=False, pressed=pressed, absolute=absolute)
    ...
    #-----------------------------------------------------------
    def ReleaseMouseInput(self, button = "left", coords = (None, None), pressed = "", absolute = False):
        "Release the mouse button"
        _perform_click_input(self, button, coords, button_down=False, pressed=pressed, absolute=absolute)
...
#    else:
    ...
    if button.lower() == 'move':
        ...
        X_coord = coords[0] * 65535 / X_res
        Y_coord = coords[1] * 65535 / Y_res
